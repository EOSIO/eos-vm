...
TEST_CASE( "Testing wasm <br_0_wasm>", "[br_0_wasm_tests]" ) {
   ...
   CHECK(bkend.reset().call_with_return(nullptr, "env", "as-call_indirect-func")->to_ui32() == UINT32_C(20));
   CHECK(bkend.reset().call_with_return(nullptr, "env", "as-call_indirect-first")->to_ui32() == UINT32_C(21));
   CHECK(bkend.reset().call_with_return(nullptr, "env", "as-call_indirect-mid")->to_ui32() == UINT32_C(22));
   CHECK(bkend.reset().call_with_return(nullptr, "env", "as-call_indirect-last")->to_ui32() == UINT32_C(23));
   ...
   CHECK(bkend.reset().call_with_return(nullptr, "env", "nested-block-value")->to_ui32() == UINT32_C(9));
   CHECK(bkend.reset().call_with_return(nullptr, "env", "nested-br-value")->to_ui32() == UINT32_C(9));
   CHECK(bkend.reset().call_with_return(nullptr, "env", "nested-br_if-value")->to_ui32() == UINT32_C(9));
   CHECK(bkend.reset().call_with_return(nullptr, "env", "nested-br_if-value-cond")->to_ui32() == UINT32_C(9));
   CHECK(bkend.reset().call_with_return(nullptr, "env", "nested-br_table-value")->to_ui32() == UINT32_C(9));
   CHECK(bkend.reset().call_with_return(nullptr, "env", "nested-br_table-value-index")->to_ui32() == UINT32_C(9));
}
