...
TEST_CASE( "Testing wasm <align_106_wasm>", "[align_106_wasm_tests]" ) {
   ...
   CHECK(to_f32(*bkend.call_with_return(nullptr, "env", "f32_align_switch", static_cast<uint32_t>(0))) == static_cast<float>(10.0f));
   CHECK(to_f32(*bkend.call_with_return(nullptr, "env", "f32_align_switch", static_cast<uint32_t>(1))) == static_cast<float>(10.0f));
   CHECK(to_f32(*bkend.call_with_return(nullptr, "env", "f32_align_switch", static_cast<uint32_t>(2))) == static_cast<float>(10.0f));
   CHECK(to_f32(*bkend.call_with_return(nullptr, "env", "f32_align_switch", static_cast<uint32_t>(3))) == static_cast<float>(10.0f));
   CHECK(to_f64(*bkend.call_with_return(nullptr, "env", "f64_align_switch", static_cast<uint32_t>(0))) == static_cast<double>(10.0f));
   CHECK(to_f64(*bkend.call_with_return(nullptr, "env", "f64_align_switch", static_cast<uint32_t>(1))) == static_cast<double>(10.0f));
   CHECK(to_f64(*bkend.call_with_return(nullptr, "env", "f64_align_switch", static_cast<uint32_t>(2))) == static_cast<double>(10.0f));
   CHECK(to_f64(*bkend.call_with_return(nullptr, "env", "f64_align_switch", static_cast<uint32_t>(3))) == static_cast<double>(10.0f));
   CHECK(to_f64(*bkend.call_with_return(nullptr, "env", "f64_align_switch", static_cast<uint32_t>(4))) == static_cast<double>(10.0f));
