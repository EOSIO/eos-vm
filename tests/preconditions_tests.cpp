...
EOS_VM_PRECONDITION(span_and_check,
      ...
      EOS_VM_INVOKE_ON_ALL([&](auto arg, auto&&... rest) {
         if (check != 0)
            throw std::runtime_error("check != 0");
      }));
...
(module
  ...
  (func (;9;) (type 2)
    ...
    call 2)
  (memory (;0;) 1)
  (export "call_test_a" (func 3))
  (export "call_test_b" (func 4))
  (export "call_test_c" (func 5))
  (export "call_test_d" (func 6))
  (export "call_test_e" (func 7))
  (export "call_test_f" (func 8))
  (export "call_test_g" (func 9))
...
*/
   wasm_code test_wasm = {
      ...
      0x00, 0x60, 0x05, 0x7d, 0x7f, 0x7f, 0x7f, 0x7f, 0x00, 0x02, 0x37, 0x03,
      ...
      
   };
   ...
   CHECK_MSG("check != 0", bkend("env", "call_test_f"));
