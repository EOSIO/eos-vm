...
execute ccache -s
[[ ! $(cat /etc/issue) =~ "Ubuntu 18.04" ]] && CMAKE_EXTRAS="-DCMAKE_TOOLCHAIN_FILE=/workdir/.cicd/helpers/clang.make" || CMAKE_EXTRAS="-DCMAKE_CXX_COMPILER='clang++' -DCMAKE_C_COMPILER='clang'"
