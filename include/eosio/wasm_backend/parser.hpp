...
namespace eosio { namespace wasm_backend {
   ...
   class binary_parser {
      public:
         ...
         void parse_module( wasm_code_ptr& code, size_t sz, module<Backend>& mod );
         ...
         void parse_import_entry( wasm_code_ptr& code, import_entry<Backend>& ie );
         ...
         void parse_export_entry( wasm_code_ptr& code, export_entry<Backend>& ee );
         ...
         void parse_function_body_code( wasm_code_ptr& code, size_t bounds, guarded_vector<opcode, Backend>& code_bytes );
