...
GENERATE_ERROR_CATEGORY(compilation_errors, "eos-vm compilation errors")
...
#define COMPILATION_ERRORS(macro)      \
   macro(compilation_errors, general_failure)
...
CREATE_ERROR_CODES(compilation_errors, COMPILATION_ERRORS)

#define EOS_VM_CHECK(expr, err_type)                                                                                  \
   if (!UNLIKELY(expr)) {                                                                                              \
      return err_type;                                                                                                 \
   }
